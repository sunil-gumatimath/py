...
print("Total number of unique languages:", len(language))
...
for i, (lang, count) in enumerate(sorted_languages[:10]):
    print(f"{i+1}. {lang}: {count} countries")

# Find the 10 most populated countries in the world
most_populated = sorted(
    [(c["name"], c["population"]) for c in countries], key=lambda x: x[1], reverse=True
)[:10]
print("\nTen most populated countries:")
for i, (name, pop) in enumerate(most_populated):
    print(f"{i+1}. {name}: {pop:,} people")
