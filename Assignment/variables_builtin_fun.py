...
print('Data types:')
variables = [first_name, last_name, full_name, country, city, age, year, is_married, is_true, is_light_on, x, y, z]
variable_names = ['first_name', 'last_name', 'full_name', 'country', 'city', 'age', 'year', 'is_married', 'is_true', 'is_light_on', 'x', 'y', 'z']
